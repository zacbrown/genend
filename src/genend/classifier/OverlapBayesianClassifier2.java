...
public class OverlapBayesianClassifier2
{
    ...
    public void execute()
    {
        ...
        for (int piece_size: piece_sizes)
        {
            ...
            for (int kmer_size = kmer_min; kmer_size <= kmer_max; kmer_size++)
            {
                ...
                String[] org_info = parse_genome_file(input_file);
                String org_seq = org_info[1];
                ...
                for (int i = 0; i < org_len; i += offset)
                {
                    ...
                    Runnable r = new StatRun(org_info[0], tmp_str, org_len,
    ...
    {
        private int total_frags, piece_size, kmer_size, org_matches, org_len;
        private Vector<ResultObj> ret_vector;
        private String input_frag, spec_name;
        private HashMap<String, HashMap<String, Double>> rel_distribs;
        private Random rg;
        private ThreadPoolExecutor tpe;

        StatRun(String spec_name, String input_frag, int org_len, int piece_size,
        ...
        public void run()
        {
            ...
            for (int ind = 1; ind < str_kmer_len - kmer_size + 1; ind++) {
                ...
                if (!SeqUtils.matchBases(tmp_frag)) {
                    continue;
                }
