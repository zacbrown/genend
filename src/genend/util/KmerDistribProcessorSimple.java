...
public class KmerDistribProcessorSimple
{
    private String genome_dir, output_dir, file_type;
    ...
    public KmerDistribProcessorSimple(String genome_dir, String output_dir,
